using KITAB.CRUD.Products.CrossCutting.Utils;
using System;
using System.Collections.Generic;
using System.Linq;

namespace KITAB.CRUD.Products.CrossCutting.Validations
{
    public class CPFValidacao
    {
        ...
        {
            string _cpfNumeros = Numericos.ApenasNumeros(cpf);
    ...
    public class CNPJValidacao
    {
        ...
        {
            string _cnpjNumeros = Numericos.ApenasNumeros(cpnj);
